...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-between">
    ...
    <h3>Add New Genre</h3> <form action="upload_genre.php" method="post" enctype="multipart/form-data">
        <b>Name:</b><br>
        <input pattern='[^"]+' required type="text" name="genreName" placeholder="Genre Name"><br>
        <b>Description:</b><br>
        <input pattern='[^"]+' required type="text" name="genreDesc" placeholder="Description"><br>
        <input type="submit" name="upload" value="Add Genre"></form>

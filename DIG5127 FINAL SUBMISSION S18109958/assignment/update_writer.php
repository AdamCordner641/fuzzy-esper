...
<?php
    if (isset($_POST['upload'])) {
        ...
        $writerFName = $_POST['writerFName'];
        $writerSName = $_POST['writerSName'];
        $writerDOB = date("Y-m-d", strtotime($_POST['writerDOB']));
        
        $sql = 'UPDATE writer SET writerFName="'.$writerFName.'",writerSName="'.$writerSName.'", writerDOB="'.$writerDOB.'" WHERE writerID="'.$writerID.'"';

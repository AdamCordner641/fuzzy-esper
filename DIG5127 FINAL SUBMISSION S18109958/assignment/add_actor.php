...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-between">
    ...
    <form class="form-inline" action="search_results.php" method="post" enctype="multipart/form-data">
        ...
        <h3>Add New Actor</h3> 
        <form action="upload_actor.php" method="post" enctype="multipart/form-data">
        <b>Name:</b><br> <input pattern='[^-,"]+' required type="text" name="actorFName" placeholder="First Name"> <input pattern='[^-,"]+' required type="text" name="actorSName" placeholder="Surname"> <br>
        <b>Date of Birth:</b><br> <input required type="date" name="actorDOB"> <br>
        <b>Upload Photo:</b><br> <input required type="file" name="actorImg" id="file"><br>

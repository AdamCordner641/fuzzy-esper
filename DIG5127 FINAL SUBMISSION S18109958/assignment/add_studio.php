...
<h3>Add New Studio</h3> <form action="upload_studio.php" method="post" enctype="multipart/form-data">
        <b>Name:</b><br>
        <input pattern='[^-,"]+' required type="text" name="studioName" placeholder="Studio Name"> <br>
        <b>Address:</b><br>
        <input pattern='[^-,"]+' required type="text" name="studioAddress" placeholder="Address"> <br>
        <b>Year Founded:</b><br>
        <input pattern='[0-9]+' required type="text" name="yearFounded" maxlength="4"  placeholder="Year Founded"> <br>
        <b>Founders:</b><br>
        <input pattern='[^-,"]+' required type="text" name="founder" placeholder="Founders"><i> (Separated  by comma)</i> <br>
        <b>Key People:</b><br>
        <input pattern='[^-,"]+' required type="text" name="people" placeholder="Key People"><i> (Separated by comma)</i><br>
        <input name="upload" required type="submit" value="Add Studio"></form>

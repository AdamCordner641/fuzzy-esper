...
<div class="jumbotron text-center">
  <h1>Welcome to <span class="logo-font"><i>watchr</i></span></h1>
  <p>Browse info about all your favourite movies, TV shows, actors, and more!</p>
</div>

<div class="container-fluid"> 
  <div class="row">
    <div class="col-sm-4" align="center">
      <a href="http://localhost/assignment/browse_movies.php"><h3><font color="black">Browse Movies and TV Shows
          </font></h3>
      <img class="no-text-deco wide-himg" src="noun_Movie_2998501.png" alt="logo">
      </a>
    </div>
    <div class="col-sm-4" align="center">
        <h3>Let us help you find what you're looking for</h3>
        <form class="form-inline" action="search_results.php" method="post">
            <input class="form-control mr-sm-2 col-sm-12" type="text" placeholder="Search" name="searchVal">
            <button class="btn btn-success col-sm-12" type="submit" name="upload">Search</button>
        </form>
    </div>
        <div class="col-sm-4" align="center">  
        <a href="http://localhost/assignment/browse_actors.php">
            <h3><font color="black">Browse Actors</font></h3>
        <img class="no-text-deco wide-himg" src="noun_Actor_1872400.png" alt="logo">
      </a>
        </div>
  </div>
</div>

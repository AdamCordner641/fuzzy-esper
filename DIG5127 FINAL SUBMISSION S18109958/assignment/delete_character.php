...
<?php
    ...
    $sql = "DELETE FROM characters WHERE characterID = '$val1'";

    if ($conn->query($sql) === TRUE) {
        ?>
        <center>
            <h3>Record deleted successfully.</h3><br>
            <p>Please refresh the previous page to see the record has been removed.</p>
        </center>
        <?php
    } else {
        ?>

...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-between">
    ...
    <h3>Add New Writer</h3> <form action="upload_writer.php" method="post" enctype="multipart/form-data">
        <b>Name:</b><br>
        <input pattern='[^"]+' required type="text" name="writerFName" placeholder="First Name"> <input pattern='[^"]+' required type="text" name="writerSName" placeholder="Surname"> <br>
        <b>Date of Birth:</b><br>
        <input required type="date" name="writerDOB"> <br>
        <input type="submit" name="upload" value="Add Writer"></form>

...
<?php
    if (isset($_POST['upload'])) {
        ...
        $directorDOB = date("Y-m-d", strtotime($_POST['directorDOB']));
        
        $sql = 'UPDATE director SET directorFName="'.$directorFName.'",directorSName="'.$directorSName.'", directorDOB="'.$directorDOB.'" WHERE directorID="'.$directorID.'"';
